/*******************************************************************************
Copyright(c) Ry Wells. All rights reserved.
  Driver for DIY OTA cover using arduino and servo
  
  Based on HandiCap Driver by: 
  Copyright(c) 2017 Jarno Paananen. All right reserved.
  Driver for HandiCap dust cap / flat panel
...
class HandiCap : public INDI::DefaultDevice, public INDI::LightBoxInterface, public INDI::DustCapInterface
{
  public:
    HandiCap();
    virtual ~HandiCap() = default;
  ...
  protected:
    ...
    virtual bool maxCapAngle(uint16_t value);
